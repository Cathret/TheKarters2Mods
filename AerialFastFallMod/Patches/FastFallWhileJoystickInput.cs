...
public class FastFallWhileJoystickInput_ConfigData
{
...
public class FastFallWhileJoystickInput
{
    private static FastFallWhileJoystickInput Instance { get; set; }
    ...
    public static void LoadConfig(FastFallWhileJoystickInput_ConfigData _configData)
    {
    ...
    {
        _harmony.PatchAll(typeof(FastFallWhileJoystickInput));
    }
